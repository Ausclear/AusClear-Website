...
export const metadata: Metadata = { title: 'Baseline Security Clearance Australia | AusClear', description: 'Baseline Security Clearance sponsorship. Access to PROTECTED classified information. Requirements, fees, process and timelines.' };

export default function Page() {
  return (<><Navigation />
    <main className="pt-28 pb-20 px-6 lg:px-12">
      <div className="max-w-[1000px] mx-auto">
        <Breadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Services', href: '/services' }, { label: 'Baseline Security Clearance' }]} />
        <Reveal>
          <h1 className="font-['Playfair_Display'] text-[clamp(2.2rem,4vw,3.2rem)] font-normal leading-tight mb-8">Baseline Security Clearance</h1>
          <p className="text-[1.05rem] text-[#9a968e] font-light leading-relaxed max-w-[800px] mb-12">Access to information classified up to <strong className="text-[#c9a84c] font-medium">PROTECTED</strong>. AusClear provides direct sponsorship for this clearance level with full case management and AGSVA-aligned compliance.</p>
        </Reveal>
        <Reveal>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-[rgba(201,168,76,0.12)] mb-16">
            <div className="bg-[#141414] p-8 text-center"><div className="text-[0.65rem] tracking-[0.2em] uppercase text-[#6b6760] mb-2">AGSVA Fee</div><div className="font-['Playfair_Display'] text-2xl text-[#c9a84c]">$884</div><div className="text-[0.72rem] text-[#6b6760] mt-1">inc. GST</div></div>
            <div className="bg-[#141414] p-8 text-center"><div className="text-[0.65rem] tracking-[0.2em] uppercase text-[#6b6760] mb-2">Processing Time</div><div className="font-['Playfair_Display'] text-2xl text-[#f0ede6]">20 business days</div></div>
            <div className="bg-[#141414] p-8 text-center"><div className="text-[0.65rem] tracking-[0.2em] uppercase text-[#6b6760] mb-2">Background History</div><div className="font-['Playfair_Display'] text-2xl text-[#f0ede6]">5 years</div></div>
          </div>
        </Reveal>
        <Reveal>
          <div className="space-y-8 mb-16">
            ...
            <div className="bg-[#141414] border border-[rgba(201,168,76,0.12)] p-10">
              ...
              <div className="space-y-3 text-[0.9rem] text-[#9a968e] font-light">
                ...
                <div className="flex gap-3"><span className="text-[#c9a84c]">&#x2014;</span>5 years employment and residential address history</div>
              </div>
            </div>
          </div>
        </Reveal>
